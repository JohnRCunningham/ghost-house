...
class StrongPax(PhaseGhost):
	def __init__(self, pos):
		Ball.__init__(self, "Playdnl.png", [0,0], pos)
		self.upImages = [pygame.image.load("strongPlayupr.png"),
						 pygame.image.load("strongPlayupl.png"),]
		self.downImages = [pygame.image.load("strongPlaydnl.png"),
						   pygame.image.load("strongPlaydnr.png"),]
		self.leftImages = [pygame.image.load("strongPlayltl.png"),
